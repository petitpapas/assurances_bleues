...
import 'request_money_transfer2_screen.dart';

class RequestMoneyTransferScreen extends StatelessWidget {
  const RequestMoneyTransferScreen({Key? key}) : super(key: key);
  @override
            ...
            children: [
              ...
              RoundedElevatedButton(
                onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const RequestMoneyTransfer2Screen(),
                  ),
                ),
                text: "Next",
                padding: const EdgeInsets.symmetric(
        ...
        child: ListView(
          ...
          children: [
            ...
            const CustomListTileWithCheckBox(
              subTitle: "Alex Hartman & 3 others",
              title: "Alex Hartman ",
            ),
